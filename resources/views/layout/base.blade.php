...
<footer class="bg-dark text-center text-white">
    ...
    <div class="container p-4">
      ...
      <section class="mb-4">
        ...
        <!-- Github -->
        <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button"
          ><i class="fab fa-github"><i class="bi bi-github"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
      ...
      {{-- <section class="mb-4">
        <p>
          ¡ Esta es una tienda online donde encontraras todo lo que necesites !
        </p>
      </section> --}}
      <!-- Section: Text -->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled mb-0">
              <li>
                <a href="#!" class="text-white">Habitacion sencilla</a>
              </li>
              <li>
                <a href="#!" class="text-white">Habitacion doble</a>
              </li>
              <li>
                <a href="#!" class="text-white">Pasadia</a>
              </li>
              <li>
                <a href="#!" class="text-white">Especiales</a>
              </li>
            </ul>
          </div>
          <!--Grid column-->
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li>
                <a href="#!" class="text-white">Peticiones, quejas o reclamos</a>
              </li>
              <li>
                <a href="#!" class="text-white">Autorizacion para el tratamiento de datos personales</a>
              </li>
              <li>
                <a href="#!" class="text-white">Aplicar garntia</a>
              </li>
            </ul>
          </div>
          <!--Grid column-->
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled mb-0">
              <li>
                <a href="#!" class="text-white"> Estamos ubicados en: </a>
              </li>
            </ul>
          </div>
          <!--Grid column-->
          ...
          <!--Grid column-->
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            <h5 class="text-uppercase">Medios de pago</h5>
  
            <ul class="list-unstyled mb-0">
              <li>
                <a href="#!" class="text-white">PSE</a>
              </li>
              <li>
                <a href="#!" class="text-white">TARJETAS DE CREDITO</a>
              </li>
              <li>
                <a href="#!" class="text-white">EFECTY</a>
              </li>
              <li>
                <a href="#!" class="text-white">PAGO CONTRA ENTREGA</a>
              </li>
            </ul>
          </div>
          <!--Grid column-->
